...
//        chart.getLegend().setAnchor(Legend.SOUTH);
        ...
        chartPanel.setBackground(new Color(255, 255, 0));
    ...
    private CategoryDataset createDataset2() {
        ...
        // row keys...
        final String series1 = "Room AC";

        // column keys...
        final String category1 = "Junuary";
        ...
        dataset.addValue(56.0, series1, category9);
        dataset.addValue(37.0, series1, category10);
        dataset.addValue(77.0, series1, category11);
        dataset.addValue(18.0, series1, category12);
    ...
    public static void main(final String[] args) {
        ...
        final DualAxisDemo demo = new DualAxisDemo("Statistics");
        demo.pack();
